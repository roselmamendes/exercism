...
class PangramTests(unittest.TestCase):
    ...
    def test_missing_x_in_the_phrase_with_less_than_total_of_alphabet(self):
        self.assertFalse(is_pangram('quick movement of the enemy will jeopardize five gunboats'))
